...
function themeChanger(){
    let checkBoxDocument = document.getElementById("flexSwitchBox");
    if(checkBoxDocument.checked == true){
        ...
        document.getElementById("codeExecutionOutput").contentDocument.getElementsByTagName("html")[0].setAttribute("data-bs-theme","dark");
        document.getElementById("iframeBorderTheme").setAttribute("class", "ratio ratio-21x9 border border-3 border-info rounded");
    } else {
        ...
        document.getElementById("codeExecutionOutput").contentDocument.getElementsByTagName("html")[0].setAttribute("data-bs-theme","light");
